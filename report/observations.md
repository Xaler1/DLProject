...
- Questiions to ask:
    - There are likelihood values given for each label, currently I'm using the BCELoss() with those likelihoods directly. For AUC metric it needs a binary label, for which I'm thresholding if logit is over 1.
